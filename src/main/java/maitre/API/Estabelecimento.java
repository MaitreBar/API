...
public abstract class Estabelecimento implements IReserva {
    ...
    public void checkIn(User u){ //à ser alterado com a regra do banco de dados, após o mesmo ser implementado.

    };

    public void checkOut(User u){ //à ser alterado com a regra do banco de dados, após o mesmo ser implementado.
